...
import DescriptionForm from "./_components/discription-form";
...
const CourseIdPage = async ({
  ...
  const completedFields = requredFields.filter(Boolean).length;

  const completionText = `(${completedFields}/${totalFields})`;

  const isComplete = requredFields.every(Boolean);
    ...
    <div className="p-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-2 mt-16">
        ...
        <div className="space-y-6">
          <div>
            <div className="flex items-center gap-x-2">
              <IconBadge size="default" variant="default" icon={ListChecks} />
          ...
          <div>
            <div className="flex items-center gap-x-2">
              <IconBadge size="default" variant="default" icon={File} />
